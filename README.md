...
**Table of Contents**  *generated with [DocToc](https://github.com/thlorenz/doctoc) ⭐ 4,460 | 🐛 27 | 🌐 JavaScript | 📅 2026-08-04*
...
Looking for resources for code languages? Take a look at [the awesome lists collection](https://github.com/sindresorhus/awesome) ⭐ 498,224 | 🐛 105 | 📅 2026-08-18.

## Generic Repositories

* [NLTK](https://github.com/nltk/nltk) ⭐ 14,700 | 🐛 228 | 🌐 Python | 📅 2026-08-20 - *Python* Natural Language Tool Kit. NLTK Source <http://www.nltk.org/>.
...
* [Tesseract.js](https://github.com/naptha/tesseract.js) ⭐ 38,641 | 🐛 47 | 🌐 JavaScript | 📅 2026-05-17 - Pure Javascript OCR for 62 Languages 📖🎉🖥 <http://tesseract.projectnaptha.com/>.
* [fastText](https://github.com/facebookresearch/fastText) ⚠️ Archived - Library for fast text representation and classification.
* [NLTK](https://github.com/nltk/nltk) ⭐ 14,700 | 🐛 228 | 🌐 Python | 📅 2026-08-20 - *Python* Natural Language Tool Kit. NLTK Source <http://www.nltk.org/>.
* [Natural](https://github.com/NaturalNode/natural) ⭐ 10,878 | 🐛 87 | 🌐 JavaScript | 📅 2026-02-22 - *Javascript* general natural language facilities for node.
* [wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,379 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-20 - Navigable waveform built on Web Audio and Canvas <https://wavesurfer-js.org/> (Also has an ELAN plugin).
* [Stanford CoreNLP](https://github.com/stanfordnlp/CoreNLP) ⭐ 10,102 | 🐛 182 | 🌐 Java | 📅 2026-06-28 - Stanford CoreNLP: A Java suite of core NLP tools. <https://stanfordnlp.github.io/CoreNLP/>.
* [stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,864 | 🐛 92 | 🌐 Python | 📅 2026-08-20 - Stanford NLP group's shared Python tools.
...
* [OpenNLP](https://github.com/apache/opennlp) ⭐ 1,602 | 🐛 16 | 🌐 Java | 📅 2026-08-19 - The Apache OpenNLP library is a machine learning based toolkit for the processing of natural language text. [Website](https://opennlp.apache.org).
* [dataverse](https://github.com/IQSS/dataverse) ⭐ 1,068 | 🐛 1,000 | 🌐 Java | 📅 2026-08-20 - A data repository framework to share and publish research data.
...
* [brown-cluster](https://github.com/percyliang/brown-cluster) ⭐ 427 | 🐛 15 | 🌐 C++ | 📅 2023-09-10 - C++ implementation of the Brown word clustering algorithm.
...
* [UniversalDependencies docs](https://github.com/UniversalDependencies/docs) ⭐ 297 | 🐛 159 | 🌐 HTML | 📅 2026-08-20 - Universal Dependencies online documentation <http://universaldependencies.org/docs/>.
...
* [UniversalDependencies tools](https://github.com/universaldependencies/tools) ⭐ 220 | 🐛 5 | 🌐 Perl | 📅 2026-08-20 - Various utilities for processing the data.
...
* [icu-dotnet](https://github.com/sillsdev/icu-dotnet) ⭐ 82 | 🐛 8 | 🌐 C# | 📅 2026-08-14 - C# wrapper for ICU4C.
...
* [libpalaso](https://github.com/sillsdev/libpalaso) ⭐ 46 | 🐛 29 | 🌐 C# | 📅 2026-08-20 - Palaso Library: A set of .Net libraries useful for developers of Language Software.
...
* [BloomDesktop](https://github.com/BloomBooks/BloomDesktop) ⭐ 44 | 🐛 53 | 🌐 C# | 📅 2026-08-20 - Bloom Desktop is a hybrid c#/javascript/html/css Windows application that dramatically "lowers the bar" for language communities who want books in their own languages. Bloom delivers a low-training, high-output system where mother tongue speakers and their advocates work together to foster both community authorship and access to external materia… <https://bloomlibrary.org/>.
* [4lang](https://github.com/kornai/4lang) ⭐ 42 | 🐛 52 | 🌐 Python | 📅 2024-04-04 - Concept dictionary using Eilenberg machines.
* [Machine](https://github.com/sillsdev/machine) ⭐ 29 | 🐛 16 | 🌐 C# | 📅 2026-08-20 - Machine is a natural language processing library for .NET that is focused on providing tools for processing resource-poor languages (used by FLEx).
...
* [Keyman](https://github.com/keymanapp/keyman) ⭐ 529 | 🐛 1,174 | 🌐 Pascal | 📅 2026-08-20 - Keyman cross platform input methods. Keyman makes it possible for you to type in over 1,000 languages on Windows, iPhone, iPad, Android tablets and phones, and even instantly in your web browser. [Website](https://keyman.com/).
...
* [brat](https://github.com/nlplab/brat) ⭐ 1,878 | 🐛 493 | 🌐 Python | 📅 2024-07-03 - brat rapid annotation tool (brat) for online text annotation.
...
* [pocketsphinx](https://github.com/cmusphinx/pocketsphinx) ⭐ 4,331 | 🐛 58 | 🌐 C | 📅 2026-08-10 - PocketSphinx is a lightweight speech recognition engine, specifically tuned for handheld and mobile devices, though it works equally well on the desktop.
* [Montreal-Forced-Aligner](https://github.com/MontrealCorpusTools/Montreal-Forced-Aligner) ⭐ 1,869 | 🐛 288 | 🌐 Python | 📅 2026-08-20 - Python interface for forced text/speech alignment.
...
* [kaldi](https://github.com/kaldi-asr/kaldi) ⭐ 15,462 | 🐛 261 | 🌐 Shell | 📅 2025-09-22 - This is now the official location of the Kaldi project.
...
* [Anki](https://github.com/dae/anki) ⭐ 29,935 | 🐛 438 | 🌐 Rust | 📅 2026-08-20 - Anki is a program to make and share flaschard decks (including audio) for any language or writing system. <https://apps.ankiweb.net/>.
...
* [moment/moment](https://github.com/moment/moment) ⭐ 47,914 | 🐛 180 | 🌐 JavaScript | 📅 2026-08-20 - A lightweight date library (JavaScript).
* [wenzhixin/bootstrap-table](https://github.com/wenzhixin/bootstrap-table) ⭐ 11,808 | 🐛 201 | 🌐 JavaScript | 📅 2026-08-18 - Bootstrap table with extra features. l10n by [@Lotuashvili](https://github.com/Lotuashvili) and [@Stichoza](https://github.com/Stichoza).
