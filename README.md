...
Looking for resources for code languages? Take a look at [the awesome lists collection](https://github.com/sindresorhus/awesome) ⭐ 506,408 | 🐛 106 | 📅 2026-09-02.

## Generic Repositories

* [NLTK](https://github.com/nltk/nltk) ⭐ 14,717 | 🐛 255 | 🌐 Python | 📅 2026-09-13 - *Python* Natural Language Tool Kit. NLTK Source <http://www.nltk.org/>.
...
* [Tesseract.js](https://github.com/naptha/tesseract.js) ⭐ 38,706 | 🐛 53 | 🌐 JavaScript | 📅 2026-05-17 - Pure Javascript OCR for 62 Languages 📖🎉🖥 <http://tesseract.projectnaptha.com/>.
...
* [wavesurfer.js](https://github.com/katspaugh/wavesurfer.js) ⭐ 10,413 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-10 - Navigable waveform built on Web Audio and Canvas <https://wavesurfer-js.org/> (Also has an ELAN plugin).
* [Stanford CoreNLP](https://github.com/stanfordnlp/CoreNLP) ⭐ 10,115 | 🐛 183 | 🌐 Java | 📅 2026-09-15 - Stanford CoreNLP: A Java suite of core NLP tools. <https://stanfordnlp.github.io/CoreNLP/>.
* [stanza](https://github.com/stanfordnlp/stanza) ⭐ 7,877 | 🐛 95 | 🌐 Python | 📅 2026-09-10 - Stanford NLP group's shared Python tools.
* [Franc](https://github.com/wooorm/franc) ⭐ 4,412 | 🐛 6 | 🌐 JavaScript | 📅 2024-06-12 - Natural language detection <https://wooorm.com/franc/>.
...
* [OpenNLP](https://github.com/apache/opennlp) ⭐ 1,601 | 🐛 25 | 🌐 Java | 📅 2026-09-15 - The Apache OpenNLP library is a machine learning based toolkit for the processing of natural language text. [Website](https://opennlp.apache.org).
* [dataverse](https://github.com/IQSS/dataverse) ⭐ 1,071 | 🐛 1,008 | 🌐 Java | 📅 2026-09-15 - A data repository framework to share and publish research data.
...
* [epitran](https://github.com/dmort27/epitran) ⭐ 838 | 🐛 32 | 🌐 Python | 📅 2026-06-18 - Grapheme to Phoneme conversion (G2P) for many low-resource languages.
...
* [UniversalDependencies docs](https://github.com/UniversalDependencies/docs) ⭐ 297 | 🐛 162 | 🌐 HTML | 📅 2026-09-15 - Universal Dependencies online documentation <http://universaldependencies.org/docs/>.
...
* [UniversalDependencies tools](https://github.com/universaldependencies/tools) ⭐ 220 | 🐛 5 | 🌐 Perl | 📅 2026-09-15 - Various utilities for processing the data.
...
* [giellakbd-ios](https://github.com/divvun/giellakbd-ios) ⭐ 58 | 🐛 38 | 🌐 Swift | 📅 2026-06-30 - An open source reimplementation of Apple's native iOS keyboard with a specific focus on support for localised keyboards. Used by [kbdgen](https://github.com/divvun/kbdgen) ⭐ 24 | 🐛 16 | 🌐 Rust | 📅 2026-09-14 (see elsewhere on this page).
...
* [libpalaso](https://github.com/sillsdev/libpalaso) ⭐ 46 | 🐛 29 | 🌐 C# | 📅 2026-09-15 - Palaso Library: A set of .Net libraries useful for developers of Language Software.
...
* [Machine](https://github.com/sillsdev/machine) ⭐ 29 | 🐛 23 | 🌐 C# | 📅 2026-09-15 - Machine is a natural language processing library for .NET that is focused on providing tools for processing resource-poor languages (used by FLEx).
...
* [nabu](https://github.com/nabu-catalog/nabu) ⭐ 21 | 🐛 12 | 🌐 Ruby | 📅 2026-09-15 - nabu is a digital media item management system that provides a catalog of audio and video items, metadata for these items, and information about the workflow status of the items. [www.paradisec.org.au](http://www.paradisec.org.au)
...
* [Keyman](https://github.com/keymanapp/keyman) ⭐ 534 | 🐛 1,161 | 🌐 Pascal | 📅 2026-09-15 - Keyman cross platform input methods. Keyman makes it possible for you to type in over 1,000 languages on Windows, iPhone, iPad, Android tablets and phones, and even instantly in your web browser. [Website](https://keyman.com/).
...
* [Keyboards](https://github.com/keymanapp/keyboards) ⭐ 204 | 🐛 38 | 🌐 HTML | 📅 2026-09-15 - Open Source Keyman keyboards.
* [jQuery.IME](https://github.com/wikimedia/jquery.ime) ⭐ 190 | 🐛 72 | 🌐 JavaScript | 📅 2026-08-27 - jQuery Input Method Editor used on Wikipedia
* [kbdgen](https://github.com/divvun/kbdgen) ⭐ 24 | 🐛 16 | 🌐 Rust | 📅 2026-09-14 - Generate keyboards and keyboard layouts for Windows, macOS, X11, iOS, Android and Chrome, from a single, simple yaml file. Also registers languages unknown to Windows, so that after installation, there is a correct and robust association between the designated BCP 47 code (including full support for ISO 639-3) and installed language tools such as keyboards, spelling checkers and other tools.
...
* [Montreal-Forced-Aligner](https://github.com/MontrealCorpusTools/Montreal-Forced-Aligner) ⭐ 1,885 | 🐛 287 | 🌐 Python | 📅 2026-08-20 - Python interface for forced text/speech alignment.
...
* [Indic-TTS](https://github.com/AI4Bharat/Indic-TTS) ⭐ 400 | 🐛 42 | 🌐 Jupyter Notebook | 📅 2024-11-08 - Open-source text-to-speech models for 13 Indian languages including Assamese, Bengali, Hindi, Kannada, Malayalam, Tamil, and Telugu.
...
* [kaldi](https://github.com/kaldi-asr/kaldi) ⭐ 15,484 | 🐛 262 | 🌐 Shell | 📅 2025-09-22 - This is now the official location of the Kaldi project.
...
* [Anki](https://github.com/dae/anki) ⭐ 30,596 | 🐛 511 | 🌐 Rust | 📅 2026-09-15 - Anki is a program to make and share flaschard decks (including audio) for any language or writing system. <https://apps.ankiweb.net/>.
...
* [AuthenticationWebService](https://github.com/FieldDB/AuthenticationWebService) ⭐ 0 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-15 - A node.js web service which mananges users and corpora creation and authentication.
...
* [moment/moment](https://github.com/moment/moment) ⭐ 47,911 | 🐛 56 | 🌐 JavaScript | 📅 2026-09-15 - A lightweight date library (JavaScript).
